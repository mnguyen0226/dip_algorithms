...
Q3: Filtering in the Frequency Domain
a/ Write the function bpFilterTF4e(type,M,N,C0,W) for performing bandpass filtering where type refers to either Ideal or Gaussian

ACTIVATE IDEAL BANDPASS FILTER
"""
import math
import cv2 as cv
import numpy as np
...
def main():
    ...
    im = cv.copyMakeBorder(im, 512, 512, 512, 512, cv.BORDER_CONSTANT,value=0) # make sure to pad
