...
Question 1b: Read the image testpattern1024.tif. Lowpass filter it using a Butterworth 
    filter of your specification so that, when thresholded, the filtered images contains only part of
    the large square on the top, right.
"""
import math
import cv2 as cv
import numpy as np
