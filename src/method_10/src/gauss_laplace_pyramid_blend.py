...
def main():
    ...
    blend_red = blend(
        laplacian_pyramid_image2r, laplacian_pyramid_image1r, mask_gaussian_pyr_listr
    )
    blend_green = blend(
        laplacian_pyramid_image2g, laplacian_pyramid_image1g, mask_gaussian_pyr_listg
    )
    blend_blue = blend(
        laplacian_pyramid_image2b, laplacian_pyramid_image1b, mask_gaussian_pyr_listb
    )
